...
if (1) {
  ...
  generalise_flag <- 0 # if one do not test CV with 20% held out test on specified  
  cv_desc = 'Train_CVTrainData_Test_CVTestData_'
  source('LABMARCS_LogisticRegression_CrossValidate_On_Selected_Data_JULY30.R')
  ...
  generalise_flag <- 1 # if one do not test CV with 20% held out test on specified  
