...
require("knitr")
opts_knit$set(root.dir = "C:/Users/bs16044/OneDrive - University of Bristol/HDR-UK-AMR/LABMARCS/brian/data/")
...
```{r}
data_dir <- 'C:/Users/bs16044/OneDrive - University of Bristol/HDR-UK-AMR/LABMARCS/brian/data/'
setwd(data_dir)
...
FBCNeutr_df = tibble(sapply(FBCNeutr_ls,c))
colnames(FBCNeutr_df) = 'Neutrophil Count'
hist.data.frame(FBCNeutr_df)

#Example Biomarker Plot for Paper
ypl = 70
spl = 5
qplot(data = FBCNeutr_df, x = `Neutrophil Count`, geom = 'histogram',  fill = I("lightblue"), 
      col = I("darkblue"), binwidth = 0.5, ylab = 'Frequency') +
  labs(subtitle = "") + #Normal reference range = 2-7.5 
  geom_histogram(color = "darkblue", fill = "lightblue", binwidth = 0.5) + 
  ...
  annotate("text", label = "Severe", x = 0.15, y = ypl, size = spl, 
           colour = "black", angle = 90, hjust = 0 , fontface = "bold") +
  annotate("text", label = "Moderate", x = .75, y = ypl, size = spl, 
           colour = "black", angle = 90, hjust = 0, fontface = "bold") +
  annotate("text", label = "Mild", x = 1.5, y = ypl, size = spl, 
           colour = "black", angle = 90, hjust = 0, fontface = "bold") +
  annotate("text", label = "Normal", x = 4.75, y = ypl + 50, size = spl, 
           colour = "black", fontface = "bold") +
  annotate("text", label = "Severe", x = 10, y = ypl, size = spl, 
           colour = "black", hjust = 0, fontface = "bold") +
  theme(text = element_text(size = 30))           

ggsave(paste(work_path,'BiomarkerDistribution_Neutrophil.pdf',sep=''), dpi = 320 )
#-------------------------------
...
ID_list = read.csv('C:/Users/bs16044/OneDrive - University of Bristol/HDR-UK-AMR/LABMARCS/brian/totalBinary3first.csv')
