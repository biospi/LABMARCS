...
```{r}
#dem = Vir %>%  #IS this a typo? Why would you use viral genetics data for general demo?
...
```{r}
# dem = Vir %>%  #Bug? Why is viral genentics being used for demographics, doesn't have this column
#   distinct(uob_ID, .keep_all = TRUE)
# dem = dem %>%
#   select(uob_ID,Gender,Age)
```
