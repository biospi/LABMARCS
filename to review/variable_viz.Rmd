...
deceasedDem = semi_join(dem, deceasedSubset, by = c("uob_ID"="uob_ID"))
...
# Semi-join for those that have died in total outcomes with the demographics table
ICU_dem = semi_join(dem, ICU_subset, by = c("uob_ID"="uob_ID"))
...
for (i in 1:nrow(total)){
  total$firstBookedIn[i] <- (total$date[which(total$uob_ID==total$uob_ID[i])][1])
}
...
```{r}
total_positiveDay <- semi_join(total,CovidCT, by = c("uob_ID" = "uob_ID", "date" = "date"))
...
```{r}
total_ICU <- semi_join(total,subset(totalOutcomes,!is.na(totalOutcomes$ITU_Start)), by = c("uob_ID" = "uob_ID") )
...
BE = BE %>% select(uob_ID,date,BE_val)
BE_day1 <- semi_join(BE,total_day1, by = c("uob_ID" = "uob_ID", "date" = "date"))
BE_positive <- semi_join(BE,total_positiveDay, by = c("uob_ID" = "uob_ID", "date" = "date"))
BE_ICU <- semi_join(BE,total_ICU, by = c("uob_ID" = "uob_ID", "date" = "date"))
...
BNP = BNP %>% select(uob_ID,date,BNP_val)
BNP_day1 <- semi_join(BNP,total_day1, by = c("uob_ID" = "uob_ID", "date" = "date"))
BNP_positive <- semi_join(BNP,total_positiveDay, by = c("uob_ID" = "uob_ID", "date" = "date"))
BNP_ICU <- semi_join(BNP,total_ICU, by = c("uob_ID" = "uob_ID", "date" = "date"))
...
CRP = CRP %>% select(uob_ID,date,CRP_val)
CRP_day1 <- semi_join(CRP,total_day1, by = c("uob_ID" = "uob_ID", "date" = "date"))
CRP_positive <- semi_join(CRP,total_positiveDay, by = c("uob_ID" = "uob_ID", "date" = "date"))
CRP_ICU <- semi_join(CRP,total_ICU, by = c("uob_ID" = "uob_ID", "date" = "date"))
...
DDM = DDM %>% select(uob_ID,date,DDM_val)
DDM_day1 <- semi_join(DDM,total_day1, by = c("uob_ID" = "uob_ID", "date" = "date"))
DDM_positive <- semi_join(DDM,total_positiveDay, by = c("uob_ID" = "uob_ID", "date" = "date"))
DDM_ICU <- semi_join(DDM,total_ICU, by = c("uob_ID" = "uob_ID", "date" = "date"))
...
eGFR = eGFR %>% select(uob_ID,date,eGFR_val)
eGFR_day1 <- semi_join(eGFR,total_day1, by = c("uob_ID" = "uob_ID", "date" = "date"))
eGFR_positive <- semi_join(eGFR,total_positiveDay, by = c("uob_ID" = "uob_ID", "date" = "date"))
eGFR_ICU <- semi_join(eGFR,total_ICU, by = c("uob_ID" = "uob_ID", "date" = "date"))
...
FER = FER %>% select(uob_ID,date,FER_val)
FER_day1 <- semi_join(FER,total_day1, by = c("uob_ID" = "uob_ID", "date" = "date"))
FER_positive <- semi_join(FER,total_positiveDay, by = c("uob_ID" = "uob_ID", "date" = "date"))
FER_ICU <- semi_join(FER,total_ICU, by = c("uob_ID" = "uob_ID", "date" = "date"))
...
fib = fib %>% select(uob_ID,date,fib_val)
fib_day1 <- semi_join(fib,total_day1, by = c("uob_ID" = "uob_ID", "date" = "date"))
fib_positive <- semi_join(fib,total_positiveDay, by = c("uob_ID" = "uob_ID", "date" = "date"))
fib_ICU <- semi_join(fib,total_ICU, by = c("uob_ID" = "uob_ID", "date" = "date"))
...
Glucose = Glucose %>% select(uob_ID,date,Glucose_val)
Glucose_day1 <- semi_join(Glucose,total_day1, by = c("uob_ID" = "uob_ID", "date" = "date"))
Glucose_positive <- semi_join(Glucose,total_positiveDay, by = c("uob_ID" = "uob_ID", "date" = "date"))
Glucose_ICU <- semi_join(Glucose,total_ICU, by = c("uob_ID" = "uob_ID", "date" = "date"))
...
HB = HB %>% select(uob_ID,date,HB_val)
HB_day1 <- semi_join(HB,total_day1, by = c("uob_ID" = "uob_ID", "date" = "date"))
HB_positive <- semi_join(HB,total_positiveDay, by = c("uob_ID" = "uob_ID", "date" = "date"))
HB_ICU <- semi_join(HB,total_ICU, by = c("uob_ID" = "uob_ID", "date" = "date"))
...
ClotAPTT = ClotAPTT %>% select(uob_ID,date,APTT_val)
ClotAPTT_day1 <- semi_join(ClotAPTT,total_day1, by = c("uob_ID" = "uob_ID", "date" = "date"))
ClotAPTT_positive <- semi_join(ClotAPTT,total_positiveDay, by = c("uob_ID" = "uob_ID", "date" = "date"))
ClotAPTT_ICU <- semi_join(ClotAPTT,total_ICU, by = c("uob_ID" = "uob_ID", "date" = "date"))
...
ClotPT = ClotPT %>% select(uob_ID,date,PT_val)
ClotPT_day1 <- semi_join(ClotPT,total_day1, by = c("uob_ID" = "uob_ID", "date" = "date"))
ClotPT_positive <- semi_join(ClotPT,total_positiveDay, by = c("uob_ID" = "uob_ID", "date" = "date"))
ClotPT_ICU <- semi_join(ClotPT,total_ICU, by = c("uob_ID" = "uob_ID", "date" = "date"))
...
CO2 = CO2 %>% select(uob_ID,date,CO2_val)
CO2_day1 <- semi_join(CO2,total_day1, by = c("uob_ID" = "uob_ID", "date" = "date"))
CO2_positive <- semi_join(CO2,total_positiveDay, by = c("uob_ID" = "uob_ID", "date" = "date"))
CO2_ICU <- semi_join(CO2,total_ICU, by = c("uob_ID" = "uob_ID", "date" = "date"))
...
O2 = O2 %>% select(uob_ID,date,O2_val)
O2_day1 <- semi_join(O2,total_day1, by = c("uob_ID" = "uob_ID", "date" = "date"))
O2_positive <- semi_join(O2,total_positiveDay, by = c("uob_ID" = "uob_ID", "date" = "date"))
O2_ICU <- semi_join(O2,total_ICU, by = c("uob_ID" = "uob_ID", "date" = "date"))
...
FBCLymph = FBCLymph %>% select(uob_ID,date,Lymphocytes)
FBCLymph_day1 <- semi_join(FBCLymph,total_day1, by = c("uob_ID" = "uob_ID", "date" = "date"))
FBCLymph_positive <- semi_join(FBCLymph,total_positiveDay, by = c("uob_ID" = "uob_ID", "date" = "date"))
FBCLymph_ICU <- semi_join(FBCLymph,total_ICU, by = c("uob_ID" = "uob_ID", "date" = "date"))
...
FBCNeutr = FBCNeutr %>% select(uob_ID,date,Neutrophils)
FBCNeutr_day1 <- semi_join(FBCNeutr,total_day1, by = c("uob_ID" = "uob_ID", "date" = "date"))
FBCNeutr_positive <- semi_join(FBCNeutr,total_positiveDay, by = c("uob_ID" = "uob_ID", "date" = "date"))
FBCNeutr_ICU <- semi_join(FBCNeutr,total_ICU, by = c("uob_ID" = "uob_ID", "date" = "date"))
...
FBCNLR = FBCNLR %>% select(uob_ID,date,NLR_val)
FBCNLR_day1 <- semi_join(FBCNLR,total_day1, by = c("uob_ID" = "uob_ID", "date" = "date"))
FBCNLR_positive <- semi_join(FBCNLR,total_positiveDay, by = c("uob_ID" = "uob_ID", "date" = "date"))
FBCNLR_ICU <- semi_join(FBCNLR,total_ICU, by = c("uob_ID" = "uob_ID", "date" = "date"))
...
FBCWCC = FBCWCC %>% select(uob_ID,date,WCC)
FBCWCC_day1 <- semi_join(FBCWCC,total_day1, by = c("uob_ID" = "uob_ID", "date" = "date"))
FBCWCC_positive <- semi_join(FBCWCC,total_positiveDay, by = c("uob_ID" = "uob_ID", "date" = "date"))
FBCWCC_ICU <- semi_join(FBCWCC,total_ICU, by = c("uob_ID" = "uob_ID", "date" = "date"))
...
HBA1c = HBA1c %>% select(uob_ID,date,HBA1c_val)
HBA1c_day1 <- semi_join(HBA1c,total_day1, by = c("uob_ID" = "uob_ID", "date" = "date"))
HBA1c_positive <- semi_join(HBA1c,total_positiveDay, by = c("uob_ID" = "uob_ID", "date" = "date"))
...
poctpH = poctpH %>% select(uob_ID,date,poctpH_val)
poctpH_day1 <- semi_join(poctpH,total_day1, by = c("uob_ID" = "uob_ID", "date" = "date"))
poctpH_positive <- semi_join(poctpH,total_positiveDay, by = c("uob_ID" = "uob_ID", "date" = "date"))
poctpH_ICU <- semi_join(poctpH,total_ICU, by = c("uob_ID" = "uob_ID", "date" = "date"))
...
poctLAC = poctLAC %>% select(uob_ID,date,poctLAC_val)
poctLAC_day1 <- semi_join(poctLAC,total_day1, by = c("uob_ID" = "uob_ID", "date" = "date"))
poctLAC_positive <- semi_join(poctLAC,total_positiveDay, by = c("uob_ID" = "uob_ID", "date" = "date"))
poctLAC_ICU <- semi_join(poctLAC,total_ICU, by = c("uob_ID" = "uob_ID", "date" = "date"))
...
LDH = LDH %>% select(uob_ID,date,LDH_val)
LDH_day1 <- semi_join(LDH,total_day1, by = c("uob_ID" = "uob_ID", "date" = "date"))
LDH_positive <- semi_join(LDH,total_positiveDay, by = c("uob_ID" = "uob_ID", "date" = "date"))
LDH_ICU <- semi_join(LDH,total_ICU, by = c("uob_ID" = "uob_ID", "date" = "date"))
...
PCT = PCT %>% select(uob_ID,date,PCT_val)
PCT_day1 <- semi_join(PCT,total_day1, by = c("uob_ID" = "uob_ID", "date" = "date"))
PCT_positive <- semi_join(PCT,total_positiveDay, by = c("uob_ID" = "uob_ID", "date" = "date"))
PCT_ICU <- semi_join(PCT,total_ICU, by = c("uob_ID" = "uob_ID", "date" = "date"))
...
PLT = PLT %>% select(uob_ID,date,PLT_val)
PLT_day1 <- semi_join(PLT,total_day1, by = c("uob_ID" = "uob_ID", "date" = "date"))
PLT_positive <- semi_join(PLT,total_positiveDay, by = c("uob_ID" = "uob_ID", "date" = "date"))
PLT_ICU <- semi_join(PLT,total_ICU, by = c("uob_ID" = "uob_ID", "date" = "date"))
...
trig = trig %>% select(uob_ID,date,trig_val)
trig_day1 <- semi_join(trig,total_day1, by = c("uob_ID" = "uob_ID", "date" = "date"))
trig_positive <- semi_join(trig,total_positiveDay, by = c("uob_ID" = "uob_ID", "date" = "date"))
trig_ICU <- semi_join(trig,total_ICU, by = c("uob_ID" = "uob_ID", "date" = "date"))
...
trop = trop %>% select(uob_ID,date,trop_val)
trop_day1 <- semi_join(trop,total_day1, by = c("uob_ID" = "uob_ID", "date" = "date"))
trop_positive <- semi_join(trop,total_positiveDay, by = c("uob_ID" = "uob_ID", "date" = "date"))
trop_ICU <- semi_join(trop,total_ICU, by = c("uob_ID" = "uob_ID", "date" = "date"))
