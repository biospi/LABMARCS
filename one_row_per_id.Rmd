...
for (id in unique(BE$ID)){
  ...
  idAdmission = idDates[1]
  avg = mean(BE[BE$ID==id,][(idDates >= idAdmission & idDates < (idAdmission) + dateRange),]$BE_val)
  nRow <- data.frame(ID=id,BE_val=avg)
  BE2 <- rbind(BE2,nRow)
}
...
for (id in unique(BNP$ID)){
  ...
  idAdmission = idDates[1]
  avg = mean(BNP[BNP$ID==id,][(idDates >= idAdmission & idDates < (idAdmission) + dateRange),]$BNP_val)
  nRow <- data.frame(ID=id,BNP_val=avg)
  BNP2 <- rbind(BNP2,nRow)
}
...
for (id in unique(CRP$ID)){
  ...
  idAdmission = idDates[1]
  avg = mean(CRP[CRP$ID==id,][(idDates >= idAdmission & idDates < (idAdmission) + dateRange),]$CRP_val)
  nRow <- data.frame(ID=id,CRP_val=avg)
  CRP2 <- rbind(CRP2,nRow)
}
...
for (id in unique(DDM$ID)){
  ...
  idAdmission = idDates[1]
  avg = mean(DDM[DDM$ID==id,][(idDates >= idAdmission & idDates < (idAdmission) + dateRange),]$DDM_val)
  nRow <- data.frame(ID=id,DDM_val=avg)
  DDM2 <- rbind(DDM2,nRow)
}
...
for (id in unique(eGFR$ID)){
  ...
  idAdmission = idDates[1]
  avg = mean(eGFR[eGFR$ID==id,][(idDates >= idAdmission & idDates < (idAdmission) + dateRange),]$eGFR_val)
  nRow <- data.frame(ID=id,eGFR_val=avg)
  eGFR2 <- rbind(eGFR2,nRow)
}
...
for (id in unique(FER$ID)){
  ...
  idAdmission = idDates[1]
  avg = mean(FER[FER$ID==id,][(idDates >= idAdmission & idDates < (idAdmission) + dateRange),]$FER_val)
  nRow <- data.frame(ID=id,FER_val=avg)
  FER2 <- rbind(FER2,nRow)
}
...
for (id in unique(fib$ID)){
  ...
  idAdmission = idDates[1]
  avg = mean(fib[fib$ID==id,][(idDates >= idAdmission & idDates < (idAdmission) + dateRange),]$fib_val)
  nRow <- data.frame(ID=id,fib_val=avg)
  fib2 <- rbind(fib2,nRow)
}
...
for (id in unique(Glucose$ID)){
  ...
  idAdmission = idDates[1]
  avg = mean(Glucose[Glucose$ID==id,][(idDates >= idAdmission & idDates < (idAdmission) + dateRange),]$Glucose_val)
  nRow <- data.frame(ID=id,Glucose_val=avg)
  Glucose2 <- rbind(Glucose2,nRow)
}
...
for (id in unique(HB$ID)){
  ...
  idAdmission = idDates[1]
  avg = mean(HB[HB$ID==id,][(idDates >= idAdmission & idDates < (idAdmission) + dateRange),]$HB_val)
  nRow <- data.frame(ID=id,HB_val=avg)
  HB2 <- rbind(HB2,nRow)
}
...
for (id in unique(HBA1c$ID)){
  ...
  idAdmission = idDates[1]
  avg = mean(HBA1c[HBA1c$ID==id,][(idDates >= idAdmission & idDates < (idAdmission) + dateRange),]$HBA1c_val)
  nRow <- data.frame(ID=id,HBA1c_val=avg)
  HBA1c2 <- rbind(HBA1c2,nRow)
}
...
for (id in unique(LDH$ID)){
  ...
  idAdmission = idDates[1]
  avg = mean(LDH[LDH$ID==id,][(idDates >= idAdmission & idDates < (idAdmission) + dateRange),]$LDH_val)
  nRow <- data.frame(ID=id,LDH_val=avg)
  LDH2 <- rbind(LDH2,nRow)
}
...
for (id in unique(PCT$ID)){
  ...
  idAdmission = idDates[1]
  avg = mean(PCT[PCT$ID==id,][(idDates >= idAdmission & idDates < (idAdmission) + dateRange),]$PCT_val)
  nRow <- data.frame(ID=id,PCT_val=avg)
  PCT2 <- rbind(PCT2,nRow)
}
...
for (id in unique(PLT$ID)){
  ...
  idAdmission = idDates[1]
  avg = mean(PLT[PLT$ID==id,][(idDates >= idAdmission & idDates < (idAdmission) + dateRange),]$PLT_val)
  nRow <- data.frame(ID=id,PLT_val=avg)
  PLT2 <- rbind(PLT2,nRow)
}
...
for (id in unique(trig$ID)){
  ...
  idAdmission = idDates[1]
  avg = mean(trig[trig$ID==id,][(idDates >= idAdmission & idDates < (idAdmission) + dateRange),]$trig_val)
  nRow <- data.frame(ID=id,trig_val=avg)
  trig2 <- rbind(trig2,nRow)
}
...
for (id in unique(trop$ID)){
  ...
  idAdmission = idDates[1]
  avg = mean(trop[trop$ID==id,][(idDates >= idAdmission & idDates < (idAdmission) + dateRange),]$trop_val)
  nRow <- data.frame(ID=id,trop_val=avg)
  trop2 <- rbind(trop2,nRow)
}
...
for (id in unique(FBCLymph$ID)){
  ...
  idAdmission = idDates[1]
  avg = mean(FBCLymph[FBCLymph$ID==id,][(idDates >= idAdmission & idDates < (idAdmission) + dateRange),]$Lymphocytes)
  nRow <- data.frame(ID=id,Lymphocytes=avg)
  FBCLymph2 <- rbind(FBCLymph2,nRow)
}
...
for (id in unique(FBCNeutr$ID)){
  ...
  idAdmission = idDates[1]
  avg = mean(FBCNeutr[FBCNeutr$ID==id,][(idDates >= idAdmission & idDates < (idAdmission) + dateRange),]$Neutrophils)
  nRow <- data.frame(ID=id,Neutrophils=avg)
  FBCNeutr2 <- rbind(FBCNeutr2,nRow)
}
...
for (id in unique(FBCWCC$ID)){
  ...
  idAdmission = idDates[1]
  avg = mean(FBCWCC[FBCWCC$ID==id,][(idDates >= idAdmission & idDates < (idAdmission) + dateRange),]$WCC)
  nRow <- data.frame(ID=id,WCC=avg)
  FBCWCC2 <- rbind(FBCWCC2,nRow)
}
...
for (id in unique(FBCNLR$ID)){
  ...
  idAdmission = idDates[1]
  avg = mean(FBCNLR[FBCNLR$ID==id,][(idDates >= idAdmission & idDates < (idAdmission) + dateRange),]$NLR_val)
  nRow <- data.frame(ID=id,NLR_val=avg)
  FBCNLR2 <- rbind(FBCNLR2,nRow)
}
...
for (id in unique(ClotAPTT$ID)){
  ...
  idAdmission = idDates[1]
  avg = mean(ClotAPTT[ClotAPTT$ID==id,][(idDates >= idAdmission & idDates < (idAdmission) + dateRange),]$APTT_val)
  nRow <- data.frame(ID=id,APTT_val=avg)
  ClotAPTT2 <- rbind(ClotAPTT2,nRow)
}
...
for (id in unique(ClotPT$ID)){
  ...
  idAdmission = idDates[1]
  avg = mean(ClotPT[ClotPT$ID==id,][(idDates >= idAdmission & idDates < (idAdmission) + dateRange),]$PT_val)
  nRow <- data.frame(ID=id,PT_val=avg)
  ClotPT2 <- rbind(ClotPT2,nRow)
}
...
for (id in unique(poctLAC$ID)){
  ...
  idAdmission = idDates[1]
  avg = mean(poctLAC[poctLAC$ID==id,][(idDates >= idAdmission & idDates < (idAdmission) + dateRange),]$poctLAC_val)
  nRow <- data.frame(ID=id,poctLAC_val=avg)
  poctLAC2 <- rbind(poctLAC2,nRow)
}
...
for (id in unique(O2$ID)){
  ...
  idAdmission = idDates[1]
  avg = mean(O2[O2$ID==id,][(idDates >= idAdmission & idDates < (idAdmission) + dateRange),]$O2_val)
  nRow <- data.frame(ID=id,O2_val=avg)
  O22 <- rbind(O22,nRow)
}
...
for (id in unique(CO2$ID)){
  ...
  idAdmission = idDates[1]
  avg = mean(CO2[CO2$ID==id,][(idDates >= idAdmission & idDates < (idAdmission) + dateRange),]$CO2_val)
  nRow <- data.frame(ID=id,CO2_val=avg)
  CO22 <- rbind(CO22,nRow)
}
...
for (id in unique(poctpH$ID)){
  ...
  idAdmission = idDates[1]
  avg = mean(poctpH[poctpH$ID==id,][(idDates >= idAdmission & idDates < (idAdmission) + dateRange),]$poctpH_val)
  nRow <- data.frame(ID=id,poctpH_val=avg)
  poctpH2 <- rbind(poctpH2,nRow)
}
...
```{r}
variables = list(BE,BNP,CRP,DDM,eGFR,FER,fib,Glucose,HB,HBA1c,LDH,PCT,PLT,trig,trop,FBCLymph,FBCNeutr,FBCWCC,FBCNLR,ClotAPTT,ClotPT,poctLAC,O2,CO2,poctpH)
